class Game {
  ...
  start() {
    ...
    //spriteGroup, numberOfSprites, spriteImage, scale
    this.addSprite(fuels, 5, fuelImage, 0.02);
    this.addSprite(powerCoins, 10, powerCoinImage, 0.07);

    this.addSprite(obstacles, obstaclesPositions.length, obstacle1, 0.05, obstaclesPositions);
  ...
  handlePowercoins(inder){

    cars[inder-1].overlap(powerCoins,function(collector, collected){
